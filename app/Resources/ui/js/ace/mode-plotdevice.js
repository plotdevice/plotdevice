define("ace/mode/plotdevice_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(require, exports, module) {
"use strict";
...
var PlotDeviceHighlightRules = function() {
    ...
    var plodFunctions = [
        ...
        'order', 'ordered', 'outputmode', 'oval', 'paginate', 'pen', 'plot', 'poly', 'pop',
    ...
    var keywordMapper = this.createKeywordMapper({
        ...
        "keyword": keywords.concat(plodClasses).join("|")
    }, "identifier");
...
define("ace/mode/plotdevice",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/plotdevice_highlight_rules","ace/mode/folding/pythonic","ace/mode/behaviour/cstyle","ace/range"], function(require, exports, module) {
"use strict";
...
var Mode = function() {
    ...
    this.$behaviour = new CstyleBehaviour(); // this.$defaultBehaviour
};
...
(function() {
    ...
    this.snippetFileId = "ace/snippets/plotdevice";
}).call(Mode.prototype);

exports.Mode = Mode;
});                (function() {
                    window.require(["ace/mode/plotdevice"], function(m) {
